...
describe('StatsEngine metrics', () => {
  it('computes red/color success, pot/miss ratios, entry success and break buckets', () => {
    ...
    expect(p1.entrySuccessRate).toBeGreaterThan(0)
    expect(p1.break20_29 + p1.break30_49 + p1.break50_79 + p1.break80_99 + p1.break100_146 + p1.break147).toBeGreaterThanOrEqual(1)
    expect(p1.avgHighBreak2Plus).toBeGreaterThan(0)
  })
})
