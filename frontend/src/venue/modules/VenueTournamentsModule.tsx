...
const VenueTournamentsModule: React.FC<VenueTournamentsModuleProps> = ({
  ...
  const {
    ...
    activeFrameIndex,
    activeFrameNoValue,
    completedResultFrames: _completedResultFrames,
    pendingResultFrame,
    selectedMatchA20PlusCount,
    selectedMatchAWins: _selectedMatchAWins,
    ...
    selectedMatchBWins: _selectedMatchBWins,
    selectedMatchBestOf,
    ...
    selectedMatchHasPlayers: _selectedMatchHasPlayers,
    ...
    selectedMatchResultType: _selectedMatchResultType,
