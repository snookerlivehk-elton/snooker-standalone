...
type ClubPublicTournamentParticipantDetailSectionProps = {
...
const ClubPublicTournamentParticipantDetailSection: React.FC<ClubPublicTournamentParticipantDetailSectionProps> = ({
  openedTournament,
  ...
  if (openedTournamentParticipants.length <= 0) return null;
...
export default ClubPublicTournamentParticipantDetailSection;
